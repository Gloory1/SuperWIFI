#!/bin/sh
# =============================================================================
# SuperWiFi OTA Update Script — v6.2.1
# =============================================================================
# Changes in this release:
#   [FEAT] Pure timestamp/epoch valid_until support (default: 0 = unlimited)
#   [FIX]  Purged all valid_days dependencies across CLI & system
#   [FIX]  SQL query isolation — added db_quarantine_voucher & db_unquarantine_voucher
#   [FIX]  NOW_TS sync state resolution & single-transaction batch performance
#   [COMP] Full POSIX ash compliance on OpenWrt
# =============================================================================
...
# =============================================================================
# 4. Apply DB migration (v6.2.1 SSOT & CLEANUP)
# =============================================================================
...
printf "${GRN}║  Valid until 0     Unlimited pre-expiry  ║${RST}\n"
printf "${GRN}║  Fast POSIX generator <0.05s             ║${RST}\n"
printf "${GRN}╚══════════════════════════════════════════╝${RST}\n\n"
