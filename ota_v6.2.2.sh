#!/bin/sh
# =============================================================================
# SuperWiFi OTA Update Script — v6.2.2
# =============================================================================
# Changes in this release:
#   [FIX]  Automatic background cloud sync trigger in sw-acct.sh (runs every 60s)
#   [FIX]  Bulk package deletion matching by both ID and Name to prevent stale packages
#   [FIX]  Cascade deletion of vouchers linked to deleted packages
#   [PERF] Pure non-blocking async execution for cloud sync engine
# =============================================================================
...
# =============================================================================
# 4. Apply DB migration (v6.2.2 SSOT & CLEANUP)
# =============================================================================
...
printf "${GRN}║  Auto Cloud Sync   Runs every 60s        ║${RST}\n"
printf "${GRN}║  Robust Package Del ID & Name matched    ║${RST}\n"
printf "${GRN}╚══════════════════════════════════════════╝${RST}\n\n"
