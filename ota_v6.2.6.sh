#!/bin/sh
# =============================================================================
# SuperWiFi OTA Update Script — v6.2.6
# =============================================================================
# Changes in this release:
#   [CRITICAL FIX] Fixed a bug introduced in v6.2.4 where bulk repairing active 
#                  sessions missing a class_id failed entirely due to a UNIQUE 
#                  constraint violation. The new logic repairs sessions sequentially.
#                  This restores accounting (data tracking) for sessions that 
#                  were "stuck" without a class_id.
# =============================================================================
