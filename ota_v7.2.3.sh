#!/bin/sh
# =============================================================================
# SuperWiFi OTA Update Script — v7.2.3
# =============================================================================
# Changes in this release:
#   [FIX] Resolved a critical sync engine bug causing packages edited in the cloud 
#         app to be overwritten by old local data from the router.
#   [FIX] Fixed router's inability to sync new packages from the cloud due to 
#         SQLite unique constraint conflicts.
# =============================================================================
