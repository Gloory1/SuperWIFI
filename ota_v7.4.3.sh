#!/bin/sh
# =============================================================================
# SuperWiFi OTA Update Script — v7.4.3
# =============================================================================
# Changes in this release:
#   [STABILITY] Maintenance & performance optimization release for v7.4 branch.
#   [FEATURE] Live Session Status & Quota details display on portal root 10.0.0.1.
#   [FEATURE] User Disconnect/Logout button support on portal status card.
#   [FEATURE] Smart Session Pause & One-click Reconnect without data loss.
#   [FIX] Auto-release bound_mac upon switching to a different voucher (Auth Switch Fix).
# =============================================================================
...
printf "${GRN}╠══════════════════════════════════════════╣${RST}\n"
printf "${GRN}║  Live Status Page  Active on 10.0.0.1    ║${RST}\n"
printf "${GRN}║  Session Logout    Smart Pause Support   ║${RST}\n"
printf "${GRN}║  Auth Switch Fix   Auto-release Old MAC  ║${RST}\n"
printf "${GRN}║  SSOT versioning   v7.4.3 Release        ║${RST}\n"
printf "${GRN}╚══════════════════════════════════════════╝${RST}\n\n"
