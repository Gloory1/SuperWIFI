#!/bin/sh
# =============================================================================
# SuperWiFi OTA Update Script — v8.1.4
# =============================================================================
# Changes in this release:
#   [FIX] Database sanitization: strip carriage returns (\r) from sqlite outputs.
#   [FIX] Traffic Control class_id input sanitization in sw_tc_apply.
#   [AUTO-OTA] Re-aligned Supabase firmware_update registration for automatic updates.
#   [RELOAD] Automated router reboot after update completion.
# =============================================================================
...
printf "${GRN}║  CRLF & Class_ID Input Sanitization      ║${RST}\n"
printf "${GRN}║  SSOT versioning   v8.1.4 Release        ║${RST}\n"
printf "${GRN}╚══════════════════════════════════════════╝${RST}\n\n"
